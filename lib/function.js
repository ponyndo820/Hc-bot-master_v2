...
const getRandomWaifu = async () => {
  try {
    ...
    const url = `https://safebooru.org/index.php?page=dapi&s=post&q=index&json=1&limit=40&pid=${randomPage}&tags=1girl+solo+highres`;
    ...
    console.error("Error Safebooru Random:", e.message);
    return null;
  }
}
